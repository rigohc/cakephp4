...
<div class="producto index content">
    <h3><?= __('Productos disponibles') ?></h3>
    <?= $this->Html->link(__('Ir a inicio'), ['controller' => './../', 'action' => ''], ['class' => 'side-nav-item']) ?>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link(__('Detalles'), ['action' => 'viewpublico', $producto->id]) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
